...
from money_transfer.forms import CustomExportForm
...
class DeliveryAdmin(VersionAdmin, ExportActionModelAdmin):
    ...
    resource_classes = [DeliveryResource]
    export_form_class = CustomExportForm
    
    def get_export_resource_kwargs(self, request, **kwargs):
        export_form = kwargs.get("export_form")
        if export_form:
            kwargs.update(date_from=export_form.cleaned_data.get('date_from'), 
                          date_to=export_form.cleaned_data.get('date_to'), 
                          author=export_form.cleaned_data.get('author'))
        return kwargs
